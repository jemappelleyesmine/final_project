...
Here are some factors that might influence commuting behavior and the associated variables that we have thought
of:

-   **Socio-demographic factors**: age, gender, educational attainment and
...
Mention that some factors probably matter more than others. - use qui 2
test? Write hypotheses.
