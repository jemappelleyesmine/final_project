...
Source: https://statistiques-locales.insee.fr/#view=map1&c=indicator To
reproduce the data selection: In "CHOISIR DES INDICATEURS", go to
TERRITOIRES, VILLES ET QUARTIERS, then select: - Nb de ménages fiscaux
2021 - Médiane du niveau de vie 2021 In "CHANGER LE DÉCOUPAGE
GÉOGRAPHIQUE", select: - Commune
...
## Description of implemented dataset manipulation
