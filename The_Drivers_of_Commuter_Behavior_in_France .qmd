...
### Handling the duplicate variables in demo_stops

```{r}
# Step 1: Fill missing values in intercommunal_code and intercommunal_label using codeEPCI and nomEPCI
demo_stops <- demo_stops %>%
  mutate(
...
# Step 2: Remove the redundant columns (codeEPCI and nomEPCI)
demo_stops <- demo_stops %>%
  select(-codeEPCI, -nomEPCI)
