...
# Step 3: Check the number of rows in each filtered dataset
cat("Number of rows in demo_stops_filtered: ", nrow(demo_stops_filtered), "\n")
cat("Number of rows in mob_pro_aggregated_filtered: ", nrow(mob_pro_aggregated_filtered), "\n")
cat("Number of rows in iltduu_aggregated_filtered: ", nrow(iltduu_aggregated_filtered), "\n")
cat("Number of rows in merged_local_mob_revenus_aggregated_filtered: ", nrow(merged_local_mob_revenus_aggregated_filtered), "\n")
```
