...
### Investigate the missing codeEPCI values from demo_stops (that are in merged local mob)
...
# Step 2: Extract codeEPCI from both datasets
demo_stops_codes <- demo_stops$codeEPCI
merged_local_mob_revenus_codes <- merged_local_mob_revenus_aggregated$codeEPCI

# Step 3: Find the codeEPCI values that are in merged_local_mob_revenus_aggregated but missing in demo_stops
missing_in_demo_stops <- setdiff(merged_local_mob_revenus_codes, demo_stops_codes)

# Step 4: Create a data frame for the missing codeEPCI values
missing_demo_stops <- data.frame(
  codeEPCI = missing_in_demo_stops
)

# Step 5: Display the missing codeEPCI values
print(missing_demo_stops)
```
