...
4.  [Data Cleaning](#data-cleaning)
    ...
    -   [Variable Renaming and
        Normalization](#variable-renaming-and-normalization)
...
7.  [Statistical Testing](#statistical-testing)
    -   [Urban/Rural Classification vs. Transportation
        Modes](#urban-rural-vs-transportation)
    -   [Socio-Professional Categories vs. Car
        Ownership](#socio-professional-vs-car-ownership)
...
economic activity. - Socio-Professional Category and Income Levels
Professional status and income levels might play a role in
transportation choices (affordability, accessibility). - Population
Density Denser areas may encourage the use of public transit and
non-motorized options, while less dense regions may rely more heavily on
private vehicles. - Commuting Distance The length of the commute is an
important variable, as it could dictate whether an individual opts for
walking, cycling, driving, or public transit. - Accessibility to
Transportation Infrastructure The availability of public transit could
affect convenience and practicality.
